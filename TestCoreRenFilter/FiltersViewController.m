...
- (void)viewDidLoad
{
    ...
    NSArray *titles = [NSArray arrayWithObjects:@"原图", @"LOMO", @"流年", @"HDR", @"碧波", @"优格", @"云端", @"淡雅", @"复古", @"古铜色", @"移轴", nil];
...
{
    [self setupFilterWithNormalImages:nil HighlightImages:nil titles:[NSArray arrayWithObjects:@"原图", @"LOMO", @"流年", @"HDR", @"碧波", @"优格", @"云端", @"淡雅", @"复古", @"古铜色", @"移轴", nil]];
}
